...
class StudentPortal(CustomerPortal):
    ...
    def student_portal(self):
        ...
        return request.render("university_management.student_portal")
    ...
    def student_info(self):
        ...
        return request.render("university_management.student_info",
                              {'values': vals})
    ...
    def student_documents(self):
        ...
        return request.render(
            "university_management.student_documents",
            {'docs': docs})
    ...
    def student_exam_result(self):
        ...
        return request.render(
            "university_management.student_exam_result",
            {'data': exam})
    ...
    def exam_subject(self):
        ...
        return request.render(
            "university_management.student_result", data)
